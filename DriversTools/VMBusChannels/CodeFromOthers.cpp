//Following code is taken from https://github.com/sysprogs/VirtualKD/blob/master/kdpatch/moduleapi.h
...
PVOID KernelGetModuleBase(PCHAR  pModuleName)
{
	...
	__try
	{
		...
		pSystemInfoBuffer = (PULONG)ExAllocatePoolWithTag(NonPagedPool, SystemInfoBufferSize * 2, 'VMbs');
